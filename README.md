...
- Snakemake (tested with 9.x) in a conda environment
- ANNOVAR with the `humandb` databases: refGene, dbnsfp42a, clinvar_20250721
- InterVar 2.2.1 (with its `config.ini` pointed at the ANNOVAR install)
- Tool paths are set in `config.yaml` under `tools:`
