...
def main():
    ...
    # thresholds kept as CLI for parity with the Snakefile, though the
    # missense cutoffs above are fixed per the thesis methodology
    p.add_argument("--af-cutoff", type=float, default=None)
    p.add_argument("--revel-cutoff", type=float, default=None)
    args = p.parse_args()
